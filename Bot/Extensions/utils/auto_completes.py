...
async def player_tag_auto_complete(ctx: SlashContext, user: User, input_player_tag: str = None) -> None:
    """
...
@staticmethod
async def player_auto_complete(ctx: SlashContext, user: User, input_player: str = None) -> None:
    """
...
async def clan_tag_auto_complete(ctx: SlashContext, user: User, input_clan_tag: str = None) -> None:
    clan_tag = user.guilds.fetch_clantag(ctx.guild_id)
    choices = []
    if clan_tag is not None:
...
async def clan_auto_complete(ctx: SlashContext, user: User, input_clan: str = None) -> None:
